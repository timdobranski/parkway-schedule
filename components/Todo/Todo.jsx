...
export default function Todo({ todoData, setTodos, setTodosFormOpen, setTodoEditId }) {
  ...
  return(
    <div className={styles.todoItem}>
      ...
      <div className={styles.todoActions}>
        <FontAwesomeIcon icon={faPencil} className={styles.actionIcon} onClick={updateTodo}/>
